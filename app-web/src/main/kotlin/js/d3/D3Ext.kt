...
fun Selection.stroke(block: (Node<*>) -> String): Selection = attr("stroke", block)
...
fun Selection.strokeWidth(block: (Node<*>) -> String): Selection = attr("stroke-width", block)
...
fun Selection.style(block: (Node<*>) -> String): Selection = attr(ATTR_STYLE, block)
